...
export default function BasicCard_arena({data, dataImg, indexOfSelected, modalImg, setSelectedPoke, handleClose}) {
  ...
  return (
    <Card sx={{ minWidth: 800, maxWidth:800, backgroundColor:"black", color:"white"}}>
